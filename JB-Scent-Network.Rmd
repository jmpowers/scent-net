...
fake.wet.scent.net.cut <- fake.wet.scent.net[rownames(fake.wet.scent.net)%in% paulsplants, ] 
...
fake.wet.net.cut <- fake.wet.net[bothplants,] #TODO: one of the sites has less plants than the other
